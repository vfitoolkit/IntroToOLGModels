...
% Third, is to substitute K=Assets-B into the general equilbrium condition for the capital market clearance. Line 153 (and similarly for line 156)
...
GeneralEqmEqns.govbudget = @(G,IncomeTaxRevenue,r,B) G+r*B-IncomeTaxRevenue; % Government budget balances (note that pensions are a seperate budget)
...
K=AggVars.Assets.Mean-Params.B;
