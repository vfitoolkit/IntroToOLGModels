...
%%
% heteroagentoptions.fminalgo=1 % the default is 1 which is fminsearch()
...
heteroagentoptions.fminalgo5.howtoupdate={...
    ...
    'pensions','pension',0,0.7;... % pensions GE condition will be positive if pension is too big, so subtract
    'bequests','AccidentBeq',1,0.5;... % bequests GE condition will be negative if AccidentBeq is too big, so add
     };
